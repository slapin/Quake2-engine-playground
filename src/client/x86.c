...
{
__asm _emit 0f h
	    __asm _emit 31 h __asm mov start, eax __asm ret} __declspec(naked)
void x86_TimerStop(void)
{
	__asm push edi
	    ...
	    __asm sub eax, bias
	    __asm js discard
	    __asm cmp eax, range __asm jge discard __asm lea edi,[edi + eax * 4]
...
__asm push edi
	    __asm mov edi, histogram
	    __asm _emit 0f h
	    __asm _emit 31 h __asm sub eax, start __asm pop edi __asm ret}
