...
int (WINAPI * qwglDescribePixelFormat) (HDC, int, UINT,
...
BOOL(WINAPI * qwglGetDeviceGammaRampEXT) (unsigned char *, unsigned char *,
					  unsigned char *);
BOOL(WINAPI * qwglSetDeviceGammaRampEXT) (const unsigned char *,
					  const unsigned char *,
					  const unsigned char *);
...
static void APIENTRY logDrawPixels(GLsizei width, GLsizei height, GLenum format,
...
static void APIENTRY logTexCoordPointer(GLint size, GLenum type, GLsizei stride,
					const void *pointer)
{
...
{
	SIG("glTexImage1D");
	dllTexImage1D(target, level, internalformat, width, border, format,
		      type, pixels);
}
...
{
	SIG("glTexImage2D");
	dllTexImage2D(target, level, internalformat, width, height, border,
		      format, type, pixels);
}
...
static void APIENTRY logTexSubImage1D(GLenum target, GLint level, GLint xoffset,
				      GLsizei width, GLenum format, GLenum type,
				      const void *pixels)
{
	SIG("glTexSubImage1D");
...
static void APIENTRY logTexSubImage2D(GLenum target, GLint level, GLint xoffset,
				      GLint yoffset, GLsizei width,
				      GLsizei height, GLenum format,
				      GLenum type, const void *pixels)
{
...
void GLimp_EnableLogging(qboolean enable)
{
	if (enable) {
		if (!glw_state.log_fp) {
			...
			Com_sprintf(buffer, sizeof(buffer), "%s/gl.log",
				    ri.FS_Gamedir());
