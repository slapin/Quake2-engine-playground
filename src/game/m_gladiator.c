...
void GladiatorGun(edict_t * self)
{
	...
	G_ProjectSource(self->s.origin,
			monster_flash_offset[MZ2_GLADIATOR_RAILGUN_1], forward,
			right, start);
	...
	monster_fire_railgun(self, start, dir, 50, 100,
...
void gladiator_die(edict_t * self, edict_t * inflictor, edict_t * attacker,
