...
// ammo
	    "if 2 "
	    "	xv	100 " "	anum " "	xv	150 " "	pic 2 " "endif "
// armor
	    "if 4 "
	    "	xv	200 " "	rnum " "	xv	250 " "	pic 4 " "endif "
// selected item
...
// chase camera
    "if 16 "
    "xv 0 " "yb -68 " "string \"Chasing\" " "xv 64 " "stat_string 16 " "endif ";
...
void SP_worldspawn(edict_t * ent)
{
	...
	if (ent->message && ent->message[0]) {
		...
		strncpy(level.level_name, level.mapname,
			sizeof(level.level_name));
